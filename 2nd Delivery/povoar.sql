...
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (4, 'Bárbara Nogueira de Sousa Rodrigues',91232170, 'Chaves', 22);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (5, 'Francisco Ademar Freitas Friande',912375671, 'Chaves', 30);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (6, 'João Pedro Fidalgo Bandeira',91235632, 'Chaves', 45);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (7, 'Francisco Ferreira',912345645, 'Viseu', 46);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (8, 'José Manuel Frade',912345763, 'Chaves', 50);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (9, 'Rui Alves',914646678, 'Chaves', 18);
INSERT INTO Pessoa (ID, Nome, "No Telefone", Localidade, Idade) VALUES (10, 'Mariana Freitas',912852674, 'Chaves', 67);
