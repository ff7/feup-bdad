...
CREATE TABLE Pessoa (ID INTEGER PRIMARY KEY UNIQUE, Nome STRING NOT NULL, "No Telefone" INTEGER NOT NULL UNIQUE, Localidade STRING NOT NULL, "Data de Nascimento" DATE NOT NULL);
